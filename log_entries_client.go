...
func (c *client) get(path string, data interface{}) (error) {
	...
	res, err := c.httpClient.Get(url, reqHeaders, data)
...
func (c *client) post(path string, in interface{}, out interface{}) (error){
	...
	res, err := c.httpClient.Post(url, reqHeaders, in, out)
...
func (c *client) put(path string, in interface{}, out interface{}) (error){
	...
	res, err := c.httpClient.Put(url, reqHeaders, in, out)
	return checkResponseStatusCode(res, err, http.StatusOK)
}
...
func (c *client) delete(path string) (error){
	...
	res, err := c.httpClient.Delete(url, reqHeaders)
